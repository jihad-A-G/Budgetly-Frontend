        ...
        <div className={props.open ? 'fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50' : 'hidden'}>
            <form className="bg-contentBackground p-6 rounded shadow-lg w-3/5 h-3/5">
                <div className="flex flex-col mb-4">
                    ...
                    <input type="text" id="fname" name="fname" className="border py-2 px-3 text-grey-darkest" onChange={e => setDescription(e.target.value)} />
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="lname" className="block text-main text-lg mb-2">Amount:</label>
                    <input type="text" id="lname" name="lname" className="border py-2 px-3 text-grey-darkest" onChange={e => setAmount(e.target.value)}/>
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="date" className="block text-main text-lg mb-2">Date:</label>
                    <input type="date" id="date" name="date" className="border py-2 px-3 text-grey-darkest"onChange={e => setDate(e.target.value)} />
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="category" className="block text-main text-lg mb-2">Category:</label>
                    <input type="text" id="category" name="category" className="border py-2 px-3 text-grey-darkest" onChange={e => setCategory(e.target.value)}/>
                </div>
