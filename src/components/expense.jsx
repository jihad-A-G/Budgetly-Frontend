...
const Expense = () => {
  ...
  return (
    <div className="Expense-container w-4/5 mr-auto ml-auto flex flex-col font-inter shadow-2xl rounded-lg bg-contentBackground">
      <div className="margin mt-20">
        ...
        <div className="Expense-table-container rounded-10 overflow-auto no-scrollbar h-[500px] ">
          <table className="Expense-table w-full ">
            <thead className="sticky top-0 bg-contentBackground">
              <tr className="Expense-heading">
            ...
            <tbody>
              <>
                {Expense.map((Expenses) => {
                  return (
                    <tr
                      className="Expense-content hover:animate-pulse hover:bg-main"
                      key={Expenses.id}
                    >
                      ...
                      <td className="flex-1 py-2 px-4 text-center">
                        <div className="flex justify-evenly">
                          <button
                            onClick={() => {
                              setAmount(Expenses.expense_amount);
                              setDate(Expenses.date);
                              setDescription(Expenses.expense_name);
                              setCategory(Expenses.Category.id);
                              setisEditOpen(true);
                              setId(Expenses.id);
                            }}
                            className="py-2 px-4"
